...
- 背景音樂使用提供的《宇宙奧祕》MP3，存於 `assets/audio/cosmic-mystery.mp3`，循環播放。隨速度由原速漸增至接近 1.8 倍，盡量保留音高；此音樂保護不限制航行速度。暫停／收藏卡畫面暫停播放，繼續時接續原位置，重新開始從歌曲開頭播放。
...
- js/audio.js：MP3 循環播放、速度連動、合成音效；替換歌曲可更新 `assets/audio/cosmic-mystery.mp3`。
